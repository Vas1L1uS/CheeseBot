...
namespace CheeseBot
{
    internal class BelperKnollePaprika : Product
    {
        ...
        {
            return new BelperKnollePaprika();
        }
    }
}